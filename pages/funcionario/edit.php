<article>
    <section class="jumbotron">
        ...
        ?>
            ...
            <ul class="breadcrumb">
                <li><a href="/pages/funcionario/gerenciamento.php">Funcionario</a> <span class="divider"></span> </li>
                <li>Atualizar</li>
            </ul>
            <form method="post" action="">
                <div class="input-group">

                    <input type="text" name="codigo" class="form-control" value="<?= $result->codigo; ?>" placeholder="codigo"/>
...
if(isset($_POST['atualizar'])){
    ...
    $sqlUpdate = 'UPDATE funcionario SET nome = :nome, email = :email WHERE id = :id';
